    ...
    <table class="table table-striped table-danger">
        <tr>
            ...
            <th>Name<a href="/web/provider/list/sorted" type="button" class="btn btn-outline-light">
                    <i class="fa fa-sort-alpha-asc"></i></a> <a href="https://app-photocenter.herokuapp.com/web/provider/list" type="button" class="btn btn-outline-light">
