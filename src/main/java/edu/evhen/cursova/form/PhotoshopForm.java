...
public class PhotoshopForm {
    ...
    public PhotoshopForm(String selling, String ondocuments, String restoration, int rolling, String artistic,
                         String professionalphoto, String goods, String adress) {
