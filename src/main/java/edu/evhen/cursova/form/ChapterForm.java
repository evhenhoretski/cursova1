...
public class ChapterForm {
    ...
    public ChapterForm(String adress, int workplace, String booth, String implemintation,
                       String manifestation, String printing, String urgent, String discountcard, int film, String sale,
                       String proceeds, String goods, Photocenter photocenter) {
        this.adress = adress;
